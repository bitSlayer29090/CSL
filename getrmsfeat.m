...
datasize = size(x,1); %should not be 1
Nsignals = size(x,2); %should not be 21001
numwin = floor((datasize - winsize)/wininc)+1; %should not be -998

% allocate memory
feat = zeros(numwin,Nsignals); %should not be 0x21001 
